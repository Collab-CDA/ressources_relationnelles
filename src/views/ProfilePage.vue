  ...
  computed: {
    ...
    avatarUrl() {
      return this.utilisateur.avatar
        ? `http://192.168.243.106:3000/uploads/${this.utilisateur.avatar}`
        : this.defaultAvatar;
    },
  },
  methods: {
    async fetchUtilisateur() {
      try {
        ...
        const response = await axios.get(`http://192.168.243.106:3000/api/utilisateurs/${userId}`, {
          headers: {
            Authorization: token,
          },
        });
    ...
    async uploadAvatar() {
      try {
        ...
        const response = await axios.put(`http://192.168.243.106:3000/api/utilisateurs/${userId}/avatar`, formData, {
          headers: {
            Authorization: token,
    ...
    async updateUtilisateur() {
      try {
        ...
        const response = await axios.put(`http://192.168.243.106:3000/api/utilisateurs/${userId}`, this.editedUtilisateur, {
          headers: {
            Authorization: token,
          },
        });
    ...
    async deleteUtilisateur() {
      try {
        ...
        await axios.delete(`http://192.168.243.106:3000/api/utilisateurs/${userId}`, {
          headers: {
            Authorization: token,
          },
        });
