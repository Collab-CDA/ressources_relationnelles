<template>
  <div class="cgu-container">
    ...
    <p><a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a> se réserve le droit de modifier unilatéralement et à tout moment le contenu des
    présentes CGU.</p>

    <h2>Article 1 : Les mentions légales</h2>
    <p>L’édition et la direction de la publication du site <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a> est assurée par Poirier-Halley
    ...
    <p>L'hébergeur du site <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a> est la société Hostinger, dont le siège social est situé au
    Hostinger, UAB Jonavos g. 60C, 44192.</p>

    <h2>Article 2 : Accès au site</h2>
    <p>Le site <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a> permet à l'Utilisateur un accès gratuit aux services suivants :</p>
    <ul>
    ...
    pas la responsabilité de <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a>. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir
    ...
    <p>Les sources des informations diffusées sur le site <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a> sont réputées fiables mais le
    ...
    <p>Malgré des mises à jour régulières, le site <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a> ne peut être tenu responsable de la
    ...
    <p>Le site <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a> ne peut être tenu pour responsable d’éventuels virus qui pourraient
    ...
    liens, il sortira du site <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a>. Ce dernier n’a pas de contrôle sur les pages web sur
    ...
    l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a>.</p>
    ...
    <p>L’information contenue dans les cookies est utilisée pour améliorer le site <a href="http://192.168.243.106:8080/">http://192.168.243.106:8080/</a>.</p>
    ...
    <p>Le site permet aux membres de publier les contenus suivants : ressources, articles, images.</p>
    <p>Dans ses publications, le membre s’engage à respecter les règles de la Netiquette (règles de bonne
    conduite de l’internet) et les règles de droit en vigueur.</p>
    <p>Le site peut exercer une modération sur les publications et se réserve le droit de refuser leur mise en
    ligne, sans avoir à s’en justifier auprès du membre.</p>
    <p>Le membre reste titulaire de l’intégralité de ses droits de propriété intellectuelle. Mais en publiant une
    ...
    recours en justice engagé par un tiers lésé contre le site sera pris en charge par l'Utilisateur.</p>
    <p>Le contenu de l'Utilisateur peut être à tout moment et pour n'importe quelle raison supprimé ou
    modifié par le site, sans préavis.</p>
    ...
    <p>CGU réalisées sur <a href="http://legalplace.fr/">http://legalplace.fr/</a></p>
  </div>
</template>
